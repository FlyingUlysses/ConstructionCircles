...
var u = function(e, r, t, n) {
    ...
    do {
        for (s = 0; o = p.exec(e); ) if (h.test(o[0])) s++ || (a = p.lastIndex, i = a - o[0].length); else if (s && !--s) {
...
a.helper.matchRecursiveRegExp = function(e, r, t, n) {
    ...
    var n = function(e, r, n, s, o, i, l, c) {
        ...
        return "" !== d && null !== d && (d = d.replace(/"/g, "&quot;"), d = a.helper.escapeCharacters(d, "*_", !1), 
        f += ' title="' + d + '"'), f += ">" + u + "</a>";
    };
    ...
    function n(e, r, n, s, o, i, l, c) {
        ...
        return c && (c = c.replace(/"/g, "&quot;"), c = a.helper.escapeCharacters(c, "*_", !1), 
        d += ' title="' + c + '"'), o && i && (o = "*" === o ? "auto" : o, i = "*" === i ? "auto" : i, 
        d += ' width="' + o + '"', d += ' height="' + i + '"'), d += " />";
    }
    ...
    function s(e, r, t) {
        ...
        if (-1 !== e.search(s)) {
            !function e(a) {
                var i = a.search(s);
                -1 !== i ? (o += "\n\n<" + r + ">" + n(a.slice(0, i), !!t) + "</" + r + ">\n\n", 
                r = "ul" === r ? "ol" : "ul", s = "ul" === r ? /^ {0,2}\d+\.[ \t]/gm : /^ {0,2}[*+-][ \t]/gm, 
                e(a.slice(i))) : o += "\n\n<" + r + ">" + n(a, !!t) + "</" + r + ">\n\n";
            }(e);
    ...
    for (var n = (e = (e = (e = t.converter._dispatch("paragraphs.before", e, r, t)).replace(/^\n+/g, "")).replace(/\n+$/g, "")).split(/\n{2,}/g), s = [], o = n.length, i = 0; i < o; i++) {
        var l = n[i];
        l.search(/~(K|G)(\d+)\1/g) >= 0 ? s.push(l) : (l = a.subParser("spanGamut")(l, r, t), 
