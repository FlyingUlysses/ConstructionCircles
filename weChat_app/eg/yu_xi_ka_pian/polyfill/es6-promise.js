...
!function(t, n) {
    "object" === ("undefined" == typeof exports ? "undefined" : e(exports)) && "undefined" != typeof module ? module.exports = n() : "function" == typeof define && define.amd ? define(n) : (void 0).ES6Promise = n();
}(0, function() {
    function t(t) {
    ...
    function v(t, e, r) {
        e.constructor === t.constructor && r === s && e.constructor.resolve === u ? p(t, e) : r === V ? b(t, V.error) : void 0 === r ? m(t, e) : n(r) ? d(t, e, r) : m(t, e);
    }
    function y(e, n) {
    ...
    function j(t, e, r, o) {
        ...
        if (i) {
            if ((s = A(r, o)) === X ? (f = !0, u = s.error, s = null) : c = !0, e === s) return void b(e, a());
        } else s = o, c = !0;
